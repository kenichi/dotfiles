...
alias tf='docker run --rm -it --user 501:501 --platform linux/amd64 -v `pwd`:/$(basename `pwd`):cached -v ${HOME}/.aws:/.aws:ro --workdir /$(basename `pwd`) hashicorp/terraform:latest'
